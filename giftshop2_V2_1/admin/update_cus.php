...
//connect_db();
  ...
  $sql2 = "select * from tbl_customer where customer_id=$cus_id";
  
  $qry=mysql_query($sql2);
  //$db=mysql_fetch_array($qry);
  
 ?>
 <form id="frm" name="frm" method="post" action="update_cus_f.php?cus_id=<?php echo $cus_id?>">
 <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1">
          <tr>
            <td colspan="2" align="center" bgcolor="#FFCC66"><span class="fontsize1">แก้ไขข้อมูล</span></td>
          </tr>
          <tr>
            ...
            <input type="text" name="cus_name" value="<?php echo $db['customer_name']?>">            
            </span></td>
          </tr>
          <tr>
            <td align="right" bgcolor="#FFFFFF"><span class="fontsize1">เบอร์โทร</span></td>
            <td align="left" bgcolor="#FFFFFF"><span class="fontsize1">
            <input type="text" name="custel" value="<?php echo  $db['customer_telephone']?>">          
            </span></td>
          </tr>
          <tr>
            <td align="right" bgcolor="#FFFFFF"><span class="fontsize1">อีเมล์</span></td>
            <td align="left" bgcolor="#FFFFFF"><span class="fontsize1">
            <input type="text" name="cusemail" value=" <?=$db['customer_email']?>">        
            </span></td>
          </tr>
          <tr>
            ...
            <td align="left" bgcolor="#FFFFFF"><p class="fontsize1">
             <input type="text" name="address" value=" <?= $db['customer_address']?>">
              <br/>
               เลือกจังหวัด : 
              ...
              ?>  
                ...
                <option value="<?=$row['province_id'];?>" <? if(isset($_session['province_id_2'])){
                $province_id = $_session['province_id_2'];
    ...
    </span><input name="submit" type="submit"  value="สั่งซื้อสินค้า" align="middle" /></p></th>
  </tr>
</table>
</form>
