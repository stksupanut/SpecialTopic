...
<table width="95%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#FFFF99">
  <tr>
    <th colspan="2" bgcolor="#FFCC66" scope="row"><span class="sizemain1">เพิ่มจำนวนสินค้า</span></th>
  </tr>
  <tr>
  ...
  <tr>
    <th align="left" scope="row"><span class="sizemain1">จำนวนที่เพิ่ม</span></th>
    <td bgcolor="#FFFFFF"><span class="sizemain1">
...
<table width="95%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#FFFF99">
  <tr class="sizemain1">
    <td width="3%" align="center" bgcolor="#FFCC66"><span class="sizemain1">
      
    ลำดับ</span></td>
    <td width="7%" align="center" bgcolor="#FFCC66">รหัสสินค้า</td>
    <td width="23%" align="center" bgcolor="#FFCC66"><span class="sizemain1">รายการสินค้า</span></td>
    <td width="13%" align="center" bgcolor="#FFCC66"><span class="sizemain1">หมวดหมู่</span></td>
    <td width="4%" align="center" bgcolor="#FFCC66"><span class="sizemain1">ราคา</span></td>
    <td width="10%" align="center" bgcolor="#FFCC66"><span class="sizemain1">จำนวนคงเหลือ</span></td>
    <td width="13%" align="center" bgcolor="#FFCC66"><span class="sizemain1">รูปภาพ</span></td>
    <td width="14%" align="center" bgcolor="#FFCC66"><span class="sizemain1">เพิ่มจำนวนสินค้า</span></td>
    <td width="4%" align="center" bgcolor="#FFCC66"><span class="sizemain1">แก้ไข</span></td>
    <td width="9%" align="center" bgcolor="#FFCC66"><span class="sizemain1">ลบ</span></td>
  </tr>
  <?
  if($numrow==0){
  ...
  ?>
  <tr>
    <td colspan="10" bgcolor="#FFFFFF" class="sizemain1"><span class="sizemain1">ไม่มีข้อมูล</span></td>
  </tr>
  <? 
  }else{
  	$i=1;
  ...
  ?>
  <tr>
    <td height="107" align="center" bgcolor="#FFFFFF" class="sizemain1">
      <?=$no?>
    </td>
    ...
    <td align="center" bgcolor="#FFFFFF" class="sizemain1"><?=number_format($db['product_price'],2)?>
    </td>
    <td align="center" bgcolor="#FFFFFF" class="sizemain1">
   ...
   ?>
    ...
    <td align="center" bgcolor="#FFFFFF" class="sizemain1">
      ...
      <? if($db['product_pic']!=''){?>
      <img src="../images/product/<?=$db['product_pic']?>" width="100"/><? }else{} ?>
    </td>
    <td align="center" bgcolor="#FFFFFF">
    ...
    <a href="main.php?module=<?=$module?>&mode=add&product_id=<?=$db['product_id']?>"><img src="../images/add.png" width="32" height="32" /></a></span></td>
	<?
	}else{}
		?>
	
    <td align="center" bgcolor="#FFFFFF" class="sizemain1"><a href="main.php?module=<?=$module?>&mode=update&product_id=<?=$db['product_id']?>"><img src="../images/edit.png" width="32" height="32" /></a></td>
    <td align="center" bgcolor="#FFFFFF">
    
      <span class="sizemain1">
      
      <? if ($db['product_status']!=2){ ?>
      <a href="main.php?module=<?=$module?>&mode=delete&product_id=<?=$db['product_id']?>" onClick="javascript:return confirm('คุณต้องการลบ<?=$db['product_name']?> ใช่หรือไม่')"><img src="../images/delete.png" width="32" height="32" /></a>
